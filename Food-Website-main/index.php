...
<header class="header">
      ...
      <!--       <a href="#" class="logo"> <i class="fas fa-utensils"></i> LEO CAFE </a> -->
...
<div class="login-form-container">
    ...
    <form action="user_login.php" method = "post">
        <h3>Login Form</h3>
        <input type="text" name="username" placeholder="enter your username" id="username" class="box">
...
<section class="popular" id="popular">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="image/Non-Veg Pizza.png" alt="">
            </div>
            <div class="content">
                <h3>non-veg pizza</h3>
                <div class="stars">
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <div class="image">
                <img src="image/Veg Pizza1.png" alt="">
            </div>
            <div class="content">
                <h3>veg pizza</h3>
                <div class="stars">
                ...
                <div class="price">Rs.1200 <span>RS.1500</span></div>
                <a href="#" class="btn">add to cart</a>
            </div>
        </div>
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <div class="image">
                <img src="image/Veg Burger.png" alt="">
            </div>
            <div class="content">
                <h3>veg burger</h3>
                <div class="stars">
                ...
                <div class="price">RS.750 <span>Rs.900</span></div>
                <a href="#" class="btn">add to cart</a>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="price">Rs.950 <span>Rs.1100</span></div>
                <a href="#" class="btn">add to cart</a>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="price">Rs.1400 <span>Rs.1500</span></div>
                <a href="#" class="btn">add to cart</a>
            </div>
        </div>
        ...
        <div class="box">
            <a href="#" class="fas fa-heart"></a>
            <div class="image">
                <img src="image/Cheese Pizza1.png" alt="">
            </div>
            <div class="content">
                <h3>cheese pizza</h3>
                <div class="stars">
                ...
                <div class="price">Rs.1600 <span>Rs.1750</span></div>
                <a href="#" class="btn">add to cart</a>
            </div>
        </div>
